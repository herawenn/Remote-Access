...
ap.add_argument("-ip", "--ip_address", required=True, help="IP Address")
ap.add_argument("-p", "--port", required=True, help="Port Number")
ap.add_argument("-i", "--icon", required=False, help="Icon for file")
ap.add_argument("-f", "--open_added", required=False, help="Bind to file")
